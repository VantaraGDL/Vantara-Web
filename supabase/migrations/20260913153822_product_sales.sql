...
alter table public.products
 ...
 add constraint products_discount_percent_valid check(discount_percent is null or (discount_percent>0 and discount_percent<100)),
 add constraint products_sale_requires_percent check(not on_sale or discount_percent is not null);
